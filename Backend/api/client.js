...
// This section will help you get a list of all the wallets.
...
// This section will help you create a new wallet.
router.post("/wallets/add", (req, response) => {
  let db_connect = dbo.getDb();
  console.log(db_connect);
  let myobj = {
    "address": req.body.address
  };
  db_connect.collection("wallets").insertOne(myobj, (err, res) => {
    if (err) throw err;
    response.json(res);
  });
});
